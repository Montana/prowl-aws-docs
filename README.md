...
This of course is assuming you are using the VMWare Fusion provider. There's a bash script I've created that does this automatically if you want to save some time.
